# 🚀 Módulo 7: React Router y Webpack
...
> La carpeta llamada **"assets"** contiene únicamente las imágenes que se muestran en este archivo README.md.  

![Módulo 7](../assets/parte-7.png)  

# Ejercicios 7.1. - 7.3.

Volvamos a trabajar con anécdotas. Utiliza la aplicación de anécdotas sin redux que se encuentra en la carpeta `routed-anecdotes` como punto de partida para los ejercicios.
...
<img src="./assets/anecdotas_enrutadas_p1_raiz.png" alt="Anécdotas Enrutadas, paso 1, raíz de la aplicación">  
...
<img src="./assets/anecdotas_enrutadas_p1_create.png" alt="Anécdotas Enrutadas, paso 1, ruta create">

## 7.2: Anécdotas Enrutadas, paso 2

Implementa una vista para mostrar una sola anécdota:  
<img src="./assets/anecdotas_enrutadas_p2_url.png" alt="Anécdotas Enrutadas, paso 2, url para mostrar una sola anécdota">  
La navegación a la página que muestra la anécdota única se realiza haciendo clic en el nombre de esa anécdota.  
<img src="./assets/anecdotas_enrutadas_p2_menu.png" alt="Anécdotas Enrutadas, paso 2, menú">
...
<img src="./assets/anecdotas_enrutadas_p3.png" alt="Anécdotas Enrutadas, paso 3">
...
<img src="./assets/anecdotas_hooks_p2_boton_borrar.png" alt="Anécdotas y Hooks, paso 2, botón para eliminar todos los campos">  
...
<img src="./assets/anecdotas_hooks_p2_advertencia.png" alt="Anécdotas y Hooks, paso 2, advertencia en la consola">  
...
Utilza el código del proyecto `country-hook` como punto de partida.  
...
<img src="./assets/hook_pais_busqueda_correcta.png" alt="Hook de País, al encontrarse un país, se muestran sus detalles">  
Si no se encuentra ningún país, se le muestra un mensaje al usuario  
<img src="./assets/hook_pais_busqueda_incorrecta.png" alt="Hook de País, si no se encuentra ningún país, se le muestra un mensaje al usuario">  
...
Puedes hacer el ejercicio en el proyecto que se encuentra en la carpeta `ultimate-hooks`. El componente _App_ del proyecto es el siguiente:
...
>
> La base para la realización de los ejercicios **7.9 al 7.21** es el código que desarrollé previamente en los módulos **Backend (module-4)** y **Frontend (module-5)**, y no el código de la solución modelo del curso.
>
> ### 🗑️ Archivos Omitidos
>
...
>
> Por último, se aclara que los **comentarios de código** del backend y frontend han sido eliminados en esta versión. Esto se hizo para mejorar la legibilidad y evitar redundancias, ya que los comentarios detallados se encuentran disponibles en las carpetas originales (`module-4` y `module-5`).
...
<img src="./assets/vista_usuarios.png" alt="Información basica relacionada con los usuarios">
...
<img src="./assets/vista_usuarios_individual.png" alt="Todos los blogs agregados por un usuario">  
Puedes acceder a esta vista haciendo clic en el nombre del usuario en la vista que enumera a todos los usuarios:  
<img src="./assets/vista_usuarios_individual_lista.png" alt="Lista que enumera todos los usuarios">  
**NB**: es casi seguro que encontrarás el siguiente mensaje de error durante este ejercicio:  
<img src="./assets/vista_usuarios_individual_error.png" alt="Error">  
...
<img src="./assets/vista_blog_separada.png" alt="Vista separada para las publicaciones de blog">  
...
<img src="./assets/vista_blog_lista_blogs.png" alt="Vista que enumera todas las publicaciones de blog">  
...
<img src="./assets/navegacion.png" alt="Menú de navegación">

## 7.18: Comentarios, paso 1

Implementa la funcionalidad para comentar las publicaciones de blog:  
<img src="./assets/comentarios_p1.png" alt="Funcionalidad para comentar publicaciones de blog">  
...
<img src="./assets/comentarios_p2.png" alt="Funcionalidad para comentar publicaciones de blog desde el frontend">
...
---
💡 *Este módulo es parte del mi camino en el Full Stack Open.*
