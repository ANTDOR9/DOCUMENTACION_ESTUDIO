...
<img src="./assets/scope-d-bloque.png" alt="Problema con el scope de bloque">  
...
El frontend ya ha sido creado por expertos externos y tu tarea es crear un backend para darle soporte al código existente.
...
Utiliza el proyecto base `patientor` que se encuentra en la carpeta correspondiente. Inicia el proyecto con la ayuda del archivo README.  
...
<img src="./assets/patientor-back-sol-ping.png" alt="Backend no responde a la solicitud de ping">  
...
<img src="./assets/ssno-respuesta.png" alt="El campo 'ssn' no está incluido en la respuesta">    
Después de crear el endpoint, asegúrate de que el `frontend` muestre la lista de pacientes:  
<img src="./assets/lista-pacientes.png" alt="Frontend devuelve la lista de pacientes">
...
<img src="./assets/resultado-ejercicio-915.png" alt="Resultado de como quedaría el ejercicio 9.15">

# Ejercicios 9.16 - 9.19

Ahora construyamos un frontend para la aplicación de diarios de vuelo de Ilari que fue desarrollada [en la sección anterior](https://fullstackopen.com/es/part9/tipando_una_aplicacion_express). El código fuente del backend puede encontrarse en la carpeta del proyecto.
...
<img src="./assets/error-axios.png" alt="Error de axios">
...
Tu solución podría verse así:  
<img src="./assets/solucion-ejercicio-919.png" alt="Como debería quedar aproximadamente la solución al ejercicio 9.19">
...
<img src="./assets/respuesta-ejercicio-920.png" alt="Como debería quedar la solución al ejercicio 9.20">
...
El resultado podría verse así:  
<img src="./assets/resultado-ejercicio-921.png" alt="Como debería quedar aproximadamente la solución al ejercicio 9.21">  
...
<img src="./assets/info-paciente-individual-back.png" alt="Campos que devuelve el backend al entrar a la ruta de un paciente individual">
...
Tu solución podría verse así:  
<img src="./assets/solucion-ejercicio-923.png" alt="Como debería quedar aproximadamente la solución al ejercicio 9.23">
...
<img src="./assets/codigos-diagnostico.png" alt="Códigos de diagnóstico del paciente junto a su respectiva descripción">
...
Como esto:  
<img src="./assets/problema-switch.png" alt="Problema en el switch case">    
Las entradas resultantes en la lista `podrían` verse así:    
<img src="./assets/resultado-ejercicio-925.png" alt="Como debería quedar aproximadamente la solución al ejercicio 9.25">
...
<img src="./assets/formulario-paciente.png" alt="Formulario del paciente">  
...
<img src="./assets/msj-error-form-paciente.png" alt="Tras ingreasr valores inválidos en el formulario, se muestra un mensaje de error">
...
<img src="./assets/formulario-mejorado.png" alt="Formulario mejorado">  
