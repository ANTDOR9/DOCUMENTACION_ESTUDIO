...
![Módulo 8](../assets/parte-8.png) 

# Ejercicios 8.1. - 8.7

A través de los ejercicios, implementaremos un backend GraphQL para una pequeña biblioteca. El backend se desarrolló tomando como base la estructura sugerida en el curso. ¡Recuerde `npm init` e instalar dependencias!  
...
El frontend utiliza la estructura base recomendada para comenzar su aplicación.  
...
<img src="./assets/vista-autores.png" alt="Vista de autores">
...
<img src="./assets/vista-libros.png" alt="Vista de libros">

## 8.10: Agregar un libro

Implemente la posibilidad de agregar nuevos libros a su aplicación. La funcionalidad puede verse así:  
<img src="./assets/agregar-libros.png" alt="Funcionalidad de agregar libros">  
...
<img src="./assets/error-agregar-libros.png" alt="Error en la consola del desarrollador">
...
<img src="./assets/año-nacimiento.png" alt="Funcionalidad para establecer el año de nacimientos de los autores">  
...
<img src="./assets/año-nacimiento-avanzado.png" alt="Nuevo formulario del año de nacimiento">
...
Cambie la aplicación de la biblioteca para que guarde los datos en una base de datos. Puede encontrar el _esquema de mongoose_ para libros y autores basado en el esquema de Mongoose del curso.  
...
<img src="./assets/interfaz-usuario.png" alt="Interfaz de usuario">  
El formulario de inicio de sesión:  
<img src="./assets/formulario-login.png" alt="Formulario de inicio de sesión">  
...
<img src="./assets/interfaz-usuario-logueado.png" alt="Interfaz de usuario al iniciar sesión un usuario">
...
<img src="./assets/filtrar-lista-libros.png" alt="Filtración en la lista de libros por género">  
...
<img src="./assets/genero-favorito.png" alt="Libros según el género favorito del usuario">
