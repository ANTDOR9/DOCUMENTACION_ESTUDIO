# 🚀 Módulo 4: Testing y Autenticación
...
<img src="./assets/func-aux-pruebas-unitarias-p2.png" alt="Funciones Auxiliares y Pruebas Unitarias, paso 2"/>  
...
Si definir tu propia lista de datos de prueba de blogs es demasiado trabajo, se utiliza una lista predefinida de blogs para las pruebas.  
...
<img src="./assets/exp-lista-blogs-p3.png" alt="Expansión de la Lista de Blogs, paso 3"/>
...
<img src="./assets/exp-lista-blogs-p5.png" alt="Expansión de la Lista de Blogs, paso 5"/>  
y la lista de todos los usuarios también muestra los blogs creados por cada usuario:  
<img src="./assets/exp-lista-blogs-blogs-p5.png" alt="Expansión de la Lista de Blogs, blogs creados por c/usuario paso 5"/>
