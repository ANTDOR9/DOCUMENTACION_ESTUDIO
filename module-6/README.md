# 🚀 Módulo 6: Gestión de Estado (Redux)
...
<img src="./assets/unicafe-revisitado-p2.png" alt="Unicafe Revisitado, paso 2">

# Ejercicios 6.3. - 6.8.

Hagamos una nueva versión de la aplicación de votación de anécdotas de la parte 1. Este proyecto utiliza la base de `redux-anecdotes` para la solución.  
...
<img src="./assets/anecdotas-resultado-final.png" alt="Resultado final al terminar ejercicio 6.8">
...
<img src="./assets/mejores-anecdotas-p7.png" alt="Mejores Anécdotas, paso 7">  
...
<img src="./assets/mejores-anecdotas-p11.png" alt="Mejores Anécdotas, paso 11">  
...
Como datos de backend iniciales, se utiliza un archivo `anecdotes.json` estándar.
...
Ahora hagamos una nueva versión de la aplicación de anécdotas que use a la librería React Query. Este proyecto utiliza `query-anecdotes` como punto de partida. El proyecto tiene un JSON Server instalado, la operación del cual se ha modificado ligeramente (revisa el archivo **server.js** para más detalles). Inicia el servidor con _npm run server_.
...
<img src="./assets/ejercicio-620.png" alt="Error al comunicarse con el servidor">    
...
<img src="./assets/ejercicio-623.png" alt="Notificación al crear o votar una anécdota">  
...
<img src="./assets/ejercicio-624.png" alt="El mensaje indica que la entrada debe tener un mínimo de 5 caracteres">  
