# 🚀 Módulo 5: Testing de Apps React
...
![Módulo 5](../assets/parte-5.png)    

# Ejercicios 5.1. - 5.4.

Ahora crearemos un frontend para el backend de la lista de blogs que creamos en la última parte. Este proyecto sirve como base para la solución, conectando el backend con un proxy como se muestra en [la parte 3](https://fullstackopen.com/es/part3/despliegue_de_la_aplicacion_a_internet#proxy).  
...
El código base se encuentra en la carpeta `bloglist-frontend`.
...
<img src="./assets/front-lista-blogs-formulario-p1.png" alt="Frontend de la Lista de Blogs, formulario de inicio de sesión">  
Si el usuario ha iniciado sesión, se muestra el nombre del usuario y una lista de blogs.  
<img src="./assets/front-lista-blogs-lista-p1.png" alt="Frontend de la Lista de Blogs, data al iniciar sesión">  
...
<img src="./assets/front-lista-blogs-p2.png" alt="Frontend de la Lista de Blogs, paso 2">  
...
<img src="./assets/front-lista-blogs-p3.png" alt="Frontend de la Lista de Blogs, paso 3">
...
<img src="./assets/front-lista-blogs-exito-p4.png" alt="Frontend de la Lista de Blogs, operaciones exitosas">  
Un inicio de sesión fallido puede mostrar la siguiente notificación:  
<img src="./assets/front-lista-blogs-error-p4.png" alt="Frontend de la Lista de Blogs, inicio de sesión fallido">  
...
<img src="./assets/front-lista-blogs-form-invisible-p5.png" alt="Frontend de la Lista de Blogs, formulario no visible">  
Se expande cuando se hace clic en el botón _create new blog_  
<img src="./assets/front-lista-blogs-form-exp-p5.png" alt="Frontend de la Lista de Blogs, formulario expandido">  
...
<img src="./assets/front-lista-blogs-p7.png" alt="Frontend de la Lista de Blogs, paso 7">  
...
<img src="./assets/front-lista-blogs-p9.png" alt="Frontend de la Lista de Blogs, paso 9">  
...
<img src="./assets/front-lista-blogs-p11.png" alt="Frontend de la Lista de Blogs, paso 9">  
...
>  <img src="./assets/playwright-papea.png" alt="Playwright vs Cypress">  
