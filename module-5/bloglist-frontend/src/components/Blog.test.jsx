  ...
  test('muestra título y autor pero no URL ni likes por defecto', () => {
    ...
    render(
      <Blog
        ...
        usuario={{ username: 'edisson_test' }} // Usuario logueado, necesario para permisos.
      />
    )
    ...
    expect(screen.getByText(/Autor Test/i)).toBeDefined()
