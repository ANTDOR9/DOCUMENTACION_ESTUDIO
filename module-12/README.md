...
> Ejercicios **12.21 y 12.22** → Dentro de la carpeta **/module-7/bloglist** y sus subcarpetas **"/backend"** y **"/frontend"**.      
> La carpeta llamada **"assets"** contiene únicamente las imágenes que se muestran en este archivo README.md.  

![Módulo 12](../assets/parte-12.png)  
...
Paso 2: Este módulo contiene la contenerización de las aplicaciones y conviértelo en tu repositorio de envío para esta parte del curso.
...
<img src="./assets/puerto-predeterminado-redis.png" alt="Busqueda del puerto de Redis en Google">
...
<img src="./assets/conexiones-red-docker.png" alt="Conexiones dentro de la red de docker">
...
<img src="./assets/conexiones-nginx.png" alt="Se agrega los servicios Nginx y todo-frontend">  
...
<img src="./assets/problema-comun.png" alt="Problema común">  
Esto ilustra lo que estamos buscando y puede ser útil si tienes problemas:  
<img src="./assets/ilustracion-solucion-problema.png" alt="Ilustración para poder solucionar el problema">
...
<img src="./assets/codigo-fuente-react.png" alt="El código fuente de React se descarga del contenedor al navegador">  
...
<img src="./assets/navegador-ejecuta-react.png" alt="El navegador ejecuta la app React y las solicitudes del backend las hace el proxy inverso Nginx">  
...
<img src="./assets/puerto-8080.png" alt="Frontend accede al backend a través de Nginx, por el puerto 8080">
